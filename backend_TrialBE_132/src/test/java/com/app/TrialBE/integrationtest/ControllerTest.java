...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM trialbe_815.FundingRound");
    jdbcTemplate.execute("DELETE FROM trialbe_815.Stage");
    jdbcTemplate.execute("DELETE FROM trialbe_815.Document");
    jdbcTemplate.execute("DELETE FROM trialbe_815.Investor");
    jdbcTemplate.execute("DELETE FROM trialbe_815.Founder");
    jdbcTemplate.execute("DELETE FROM trialbe_815.Startup");
     jdbcTemplate.execute("DELETE FROM trialbe_815.StartupFounders");
     jdbcTemplate.execute("DELETE FROM trialbe_815.StartupKeyMetrics");
     jdbcTemplate.execute("DELETE FROM trialbe_815.InvestorInvestmentPreferences");
     jdbcTemplate.execute("DELETE FROM trialbe_815.StartupPreviousRounds");
     jdbcTemplate.execute("DELETE FROM trialbe_815.FundingRoundInvestors");
